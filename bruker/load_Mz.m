function [varargout] = load_Mz(varargin)
% ** function [Mz_stack1, ..., Mz_stackN] = load_Mz(directory_Mz1, ..., directory_MzN)
%
% code adapted from D. Longo et al.
...
for n=1:nargin
    directory_Mz = varargin{n};
    
    num_ppm=0;
    cont_ppm=1;
    x=[];
    file_acqp=textread([directory_Mz '/acqp'],'%s','delimiter','=','whitespace','');
    ...
    file_imnd=textread([directory_Mz '/method'],'%s','delimiter','=','whitespace','');
    ...
    % leggi nel file reco
    file_reco=textread([directory_Mz '/pdata/1/reco'],'%s','delimiter','\n','whitespace','');
    ...
    file_meta=textread([directory_Mz '/pdata/1/reco'],'%s','delimiter','=','whitespace','');
    ...
    file_reco_slope=textread([directory_Mz '/pdata/1/reco'],'%s','delimiter','=','whitespace','');
    ...
    id_read = waitbar(0,'Loading Mz stack...');
    image_Mz=zeros(size_zx,size_zy,1,size_zz);
    
    fid=fopen([directory_Mz '/pdata/1/2dseq']);
