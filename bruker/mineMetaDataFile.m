function paramval = mineMetaDataFile(filepath, paramname)
% ** function paramval = mineMetaDataFile(filepath, paramname)
%
% Extracts parameter from a Bruker metadata file, e.g. 'method', 'acqp'
% or 'reco' file in the scan directory.
%     e.g. B1value = mineMetaDataFile(methodpath, 'PVM_MagTransPower')
