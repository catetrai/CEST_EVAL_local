...
% read acqp
file_acqp = textread([directory_M0 '/method'],'%s','delimiter','=','whitespace','');
...
% read reco
file_reco = textread([directory_M0 '/pdata/1/reco'],'%s','delimiter','\n','whitespace','');
...
file_meta=textread([directory_M0 '/pdata/1/reco'],'%s','delimiter','=','whitespace','');
...
file_reco_slope=textread([directory_M0 '/pdata/1/reco'],'%s','delimiter','=','whitespace','');
...
id_read = waitbar(0,'Loading M0...');
fid=fopen([directory_M0 '/pdata/1/2dseq']);
