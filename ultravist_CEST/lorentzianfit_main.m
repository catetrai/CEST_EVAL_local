...
switch mode
    case 'invivo'
        Pnew.FIT.modelnum  = 6;     % number of Lorentzian pools (possible 1-5)
...
%         %const.Zi   A1    G1    dw1     A2     G2    dw2     A3    G3   dw3     A4    G4   dw4    A5    G5   dw5    A6   G6   dw6
%         lb = [ 0.5  0.02  0.3  -1       0.0    0.4   +3     0.0    1    -4.5    0.0   10   -4     0.0   1    1      0.0  1  4.0]; 
%         ub = [ 1    1     10   +1       0.2    3     +4     0.4    5    -2        1   100  -1     0.2   3.5  2.5    0.6  5  4.8];
%         p0 = [ 1    0.9   1.4   0       0.025  0.5   3.5    0.02   3    -3.5    0.1   25   -1     0.01  1.5  2.2    0.1  3  4.2];
        %const.Zi   A1    G1    dw1     A2     G2    dw2     A3    G3   dw3     A4    G4   dw4    A5    G5   dw5    A6   G6   dw6
        lb = [ 0.5  0.02  0.3  -1       0.0    0.4   +3     0.0    1    -4.5    0.0   1   5.3     0.0   1    1      0.0  1  4.0]; 
        ub = [ 1    1     10   +1       0.2    3     +4     0.4    5    -2      0.6   5   6.0     0.2   3.5  2.5    0.6  5  4.5];
        p0 = [ 1    0.9   1.4   0       0.025  0.5   3.5    0.02   3    -3.5    0.1   3   5.6     0.01  1.5  2.2    0.1  3  4.2];
    ...
    case 'ultravist'
        ...
        lb = [ 0.5  0.02  0.3  -1       0.0    1     4.0     0.0    1    5   ];
